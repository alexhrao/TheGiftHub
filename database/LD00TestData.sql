...
-- Insert into users:
INSERT INTO users (users.FirstName, users.LastName, users.UserEmail, users.DateOfBirth, users.PasswordID, users.UserBio) VALUES ('Alex', 'Rao', 'alexhrao@gmail.com', "1996-07-03", 1, "I LOVE to have fun!");
INSERT INTO users (users.FirstName, users.LastName, users.UserEmail, users.DateOfBirth, users.PasswordID, users.UserBio) VALUES ('Raeedah', 'Choudhury', 'rchoudhury@gmail.com', "1997-11-19", 2, "I love my boyfriend");
-- Insert into events:
